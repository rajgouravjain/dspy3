...
if __name__ == "__main__":
    ...
    avro_rdd = sc.newAPIHadoopFile(
        path,
        "com.apache.avro.mapreduce.AvroKeyInputFormat",
        "com.apache.avro.mapred.AvroKey",
        "com.apache.hadoop.io.NullWritable",
        keyConverter="com.apache.spark.examples.pythonconverters.AvroWrapperToJavaConverter",
        conf=conf)
