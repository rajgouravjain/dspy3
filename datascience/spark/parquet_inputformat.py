...
if __name__ == "__main__":
    ...
    parquet_rdd = sc.newAPIHadoopFile(
        path,
        'com.apache.parquet.avro.AvroParquetInputFormat',
        'java.lang.Void',
        'com.apache.avro.generic.IndexedRecord',
        valueConverter='com.apache.spark.examples.pythonconverters.IndexedRecordToJavaConverter')
